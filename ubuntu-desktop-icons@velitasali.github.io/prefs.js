...
function buildPrefsWidget() {
    ...
    frame.add(buildSelector('dock-position', _("Dock position for extra space"), { 'disabled': _("Disabled"), 'top': _("Top"), 'bottom': _("Bottom"), 'left': _("Left"), 'right': _("Right") }));
...
function get_dock_position() {
    return settings.get_string('dock-position');
}
